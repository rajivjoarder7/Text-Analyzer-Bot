...
with gr.Blocks() as demo:
    # Title of the app with 'Text Analyzer Bot' and small font 'by RJ'
    gr.Markdown("<h1>Text Analyzer Bot <span style='font-size: 10px;'>by RJ</span></h1>")
    
    # Display version at the bottom right
    gr.Markdown("<div style='text-align: right; font-size: 8px; font-weight: bold;'>v.007</div>")
    ...
    ask_button = gr.Button("Ask", visible=False)  # Initially hidden, will only show after pressing "Ask Questions"
    ...
    question_button.click(fn=lambda: gr.update(visible=True), outputs=ask_button)  # Show ASK button only after pressing "Ask Questions"
